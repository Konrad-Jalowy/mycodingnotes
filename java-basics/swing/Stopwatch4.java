    ...
    private static void exportToHTML(String fileName) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(file))) {
            ...
            html.append("<html>\n")
                    ...
                    .append("<body>\n")
                    .append("<h1>Stopwatch Summary</h1>\n")
                    .append("<p><strong>Total Time:</strong> ").append(formatTime(elapsedMilliseconds)).append("</p>\n");

            if (!laps.isEmpty()) {
                html.append("<h2>Laps</h2>\n")
                        .append("<table border='1' cellspacing='0' cellpadding='5'>\n")
                        .append("<tr><th>Lap</th><th>Time</th></tr>\n");
                for (int i = 0; i < laps.size(); i++) {
                    html.append("<tr><td>Lap ").append(i + 1).append("</td><td>").append(laps.get(i)).append("</td></tr>\n");
                }
                html.append("</table>\n");
            }

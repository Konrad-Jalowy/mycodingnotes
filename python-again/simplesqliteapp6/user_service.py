...
def import_from_csv(filename="import_users.csv"):
    """Importuje użytkowników z pliku CSV do bazy danych."""
    try:
            ...
            with sqlite3.connect(DB_NAME) as conn:
                ...
                for row in reader:
                    ...
                    try:
                        ...
                        print(f"⚠ Użytkownik z emailem `{email}` już istnieje – pominięto.")
                        skipped_count += 1

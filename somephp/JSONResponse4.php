...
class JsonResponse {
    ...
    private string $logFile = '/tmp/json_response.log';
...
// Uncomment the following lines to see the exception when trying to send another response
// $errorResponse = new JsonResponse();
// $errorResponse->setError(404, 'Resource not found');
// $errorResponse->enableCORS();
// $errorResponse->send();

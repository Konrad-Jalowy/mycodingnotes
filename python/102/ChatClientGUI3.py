...
class ChatClientGUI:
    def __init__(self):
        ...
        # Konfiguracja stylów dla tekstu
        self.chat_display.tag_config("bold", font=("Helvetica", 10, "bold"))
    ...
    def send_message(self, event=None):
        ...
        if message:
            # Wyświetl własną wiadomość w polu czatu z pogrubieniem
            self.update_chat(f"{self.username}: {message}", "bold")
